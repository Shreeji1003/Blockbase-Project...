...
function App() {
  ...
  const contractAddress = "0xfcc9473a5A4d07efeB9aE99Ae3ac45C6649f0504"; // Paste the address recieved from Remix IDE here
        ...
        : (
          <div>
            ...
            {/*  <changes>  */}
              ...
              <p style={{ marginBottom: "0.5rem" }}>Change Your Registered Name</p>
            ...
            <div style={{ height:'40px',width:'300px',padding: '10px'}}>
                  No. of people registered = {people.length}
            </div>
